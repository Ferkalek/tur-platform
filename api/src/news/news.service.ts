    ...
    const initialNews: News[] = [
      {
        ...
        excerpt:
          'Огляд найважливіших трендів та інструментів для сучасних розробників',
        content:
          'У 2025 році веб-розробка досягла нових висот. React Server Components стали стандартом, TypeScript повністю витіснив JavaScript у корпоративному секторі. Edge computing та serverless архітектури тепер доступні всім.',
      ...
      },
      {
        ...
        content:
          "Сучасні AI-асистенти не просто автодоповнюють код - вони розуміють контекст проекту, пропонують оптимальні рішення і навіть можуть рефакторити застарілий код. GitHub Copilot, Claude та інші інструменти стали невід'ємною частиною розробки.",
      ...
      },
      {
        ...
        excerpt:
          'Від монолітів до мікросервісів - еволюція серверної архітектури',
        content:
          'NestJS став лідером серед Node.js фреймворків завдяки своїй модульності та TypeScript-first підходу. Microservices, event-driven архітектура та clean code - це вже не тренди, а стандарт індустрії.',
